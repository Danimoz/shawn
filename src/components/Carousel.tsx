...
const Carousel = () => {
  ...
  return (
    <>
      ...
      <div className="mb-4">
        <p className="text-3xl text-center my-8">Let&apos;s sell you a <span className="font-bold text-4xl text-sky-400">HOME</span> not a <span className="font-bold text-sky-300 text-4xl">HOUSE</span></p>
      </div>
    </>
  )
}
