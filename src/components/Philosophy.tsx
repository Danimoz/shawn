  ...
  return (
    <div className="mt-9">
      ...
      <div className="md:flex gap-x-4 px-8 mt-4">
        <div className="mb-3">
          <div className="flex justify-center"><FaLightbulb size={42} /></div>
        ...
        <div className="mb-3">
          <div className="flex justify-center"><FaPencilRuler size={42} /></div>
        ...
        <div className="mb-3">
          <div className="flex justify-center"><TbTargetArrow size={42} /></div>
